...
const InputEncrypt = (props) => {
  return (
    <div className={styles.input}>
      <div className={styles.plaintomorse}>
        <h2 className={styles.plaintomorseText}>
          plain text <span className={styles.colorChangeBlue}>to</span> morse{" "}
          <span className={styles.colorChangeYellow}>code</span>
        </h2>
      </div>
      ...
      <div className={styles.invertLink}>
        <Link className={styles.invertLink} to='/morsecodetoplaintext'>
          invert
        </Link>
      </div>
      <input
